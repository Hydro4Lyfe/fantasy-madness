...
export default function BracketMadnessLanding() {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center gap-3">
                <Button variant="outline" asChild className="border-white/70 text-white hover:bg-white/10 hover:border-white">
          ...
          <Card className="relative overflow-hidden border-2 border-purple-500/50">
            ...
            <div className="relative p-8 sm:p-12 text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                />
                <Button asChild size="lg" className="w-full sm:w-auto bg-gradient-to-r from-orange-500 to-purple-600 hover:from-orange-600 hover:to-purple-700 px-8 h-12">
                  <Link href="/signup">
                    Start Playing Free
