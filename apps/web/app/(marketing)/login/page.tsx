  ...
  return (
    <div className="min-h-screen bg-background dark flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-muted/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Card className="p-8 bg-card border-border shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-orange-500 to-purple-600 flex items-center justify-center mb-4">
